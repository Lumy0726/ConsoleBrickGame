...
public:
	...
	virtual void Set_consol();
	virtual void Set_color(T_color Letter, T_color Back);
	virtual void Set_color(char Input);
	virtual void Reverse_color();
protected:
	virtual C_screen_color::T_color Get_T_color(char Input);
public:
	virtual char Get_color() const;
	virtual C_screen_color::T_color Get_color_letter();
	virtual C_screen_color::T_color Get_color_background();
	virtual void Show();
	virtual void Show_opt();
	virtual void Show_opt_kr();
	virtual void Show_opt_kr(unsigned Time);
