...
C_board::C_board(unsigned Base_size, unsigned Field_size, unsigned Brick_height)
	...
	*ID_table = true;
	...
	cout << "반사판 움직이기: 방향키.(Q를 같이누르면 3배 가속.)" << endl;
	cout << "반사판 돌리기: W,E" << endl;
	cout << "반사판 돌리기(미세조정): S,D" << endl;
	cout << "벽돌 직접 추가하기: R" << endl;
	...
	cout << "정상적인 플레이를 위해서, 도스창을 우클릭하여 속성에서 폰트크기를 매우작게(6 정도) 설정해주세요." << endl;
